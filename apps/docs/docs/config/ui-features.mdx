...
| --------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| <img src="/img/version_bottom_right.png" alt="KAKA. version bottom right" style={{maxHeight: "250px"}} /> | <img src="/img/version_server_hover.png" alt="KAKA. version on GitHub icon hover" style={{maxHeight: "250px"}} /> |
